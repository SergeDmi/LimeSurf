...
void Mesh::Create_mesh(const YAML::const_iterator config , Part_set_props & propal) {
    ...
    switch (mechanics) {
        ...
        case 1 : {  
            ...
            mesh_parts=wall;
            std::cout << "# Starting  : triangulated elastic surface simulation" << std::endl;
            break; }
        ...
        case 3 : {
            ...
            mesh_parts=wall;
            std::cout << "# Starting : triangulated elastic surface + bending simulation" << std::endl;
            break; }                           
        ...
        case 4 : {
            ...
            mesh_parts=wall;
            std::cout << "# Starting : tetrahedral elastic surface simulation" << std::endl;
            break; }
    }
